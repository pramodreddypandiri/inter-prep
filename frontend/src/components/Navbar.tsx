...
import { LogOut, Plus, MessageSquare, Menu, X, Sun, Moon } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1.5">
          ...
          <button
            ...
            className="flex items-center px-3 py-2 text-[var(--muted)] hover:text-[var(--foreground)] rounded-lg hover:bg-[var(--surface)] transition-all"
          >
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-[var(--card-border)] bg-[var(--card)] animate-fade-in-scale">
          <div className="px-5 py-4 space-y-1">
            ...
            <div className="pt-2 mt-2 border-t border-[var(--card-border)] space-y-1">
              <button
                onClick={() => { toggle(); setMobileOpen(false); }}
                className="flex items-center gap-3 px-3 py-2.5 text-sm text-[var(--muted)] rounded-lg hover:bg-[var(--surface)] transition-all w-full"
              >
